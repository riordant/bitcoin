...
#include "qt/forms/ui_notifymnemonic.h"
...
void NotifyMnemonic::notify(std::vector<WalletModel*> walletModels)
{
    for (WalletModel* wallet_model : walletModels) {
        SecureString mnemonic;
        if(wallet_model->wallet().getMnemonic(mnemonic)) {
